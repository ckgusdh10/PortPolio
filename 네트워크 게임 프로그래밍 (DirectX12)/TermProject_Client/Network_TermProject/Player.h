...
public:
	...
	int getHP() { return hp; }
	void setRotateVector(XMFLOAT3X3& rotInfo) {
		m_xmf3Look = XMFLOAT3(rotInfo._11, rotInfo._12, rotInfo._13);
		m_xmf3Up = XMFLOAT3(rotInfo._21, rotInfo._22, rotInfo._23);
		m_xmf3Right = XMFLOAT3(rotInfo._31, rotInfo._32, rotInfo._33);
	};
...
class CAirplaneEnemy : public CPlayer
{
public:
	CMesh *pAirplaneMesh;
	CAirplaneEnemy();
	void setMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList,
		ID3D12RootSignature *pd3dGraphicsRootSignature);
	CAirplaneEnemy(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList,
		ID3D12RootSignature *pd3dGraphicsRootSignature);
