...
#define RANDOM_COLOR1 XMFLOAT4(rand() / float(RAND_MAX), rand() / float(RAND_MAX), rand() / float(RAND_MAX), rand() / float(RAND_MAX))
#define RANDOM_COLOR2 XMFLOAT4(rand() / float(RAND_MAX)+0.3, rand() / float(RAND_MAX)+0.3, rand() / float(RAND_MAX)+0.3, rand() / float(RAND_MAX)+0.3)
#define RANDOM_COLOR3 XMFLOAT4(rand() / float(RAND_MAX)-0.3, rand() / float(RAND_MAX)-0.3, rand() / float(RAND_MAX)-0.3, rand() / float(RAND_MAX)-0.3)
